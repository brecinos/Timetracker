...
namespace Mvc3Razor.Controllers
{
    public class ProductRepository
    {
        ...
        public CountriesRepository()
        {
            ...
            countriesData = XDocument.Load(HttpContext.Current.Server.MapPath("~/App_Data/Products.xml"));
            var countries = from country in countriesData.Descendants("country")
                           ...
                           country.Element("description").Value, (ulong)country.Element("area"),(ulong)country.Element("population"),
